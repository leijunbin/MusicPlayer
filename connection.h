...
static bool CreatConnection(){
    ...
    query.exec(QString("create table LikeMusic (id int,MusicName varchar,FileName varchar,primary key(id,MusicName,FileName))"));//我的喜欢数据列表
    query.exec(QString("create table CollectMusic (id int,MusicName varchar,FileName varchar,primary key(id,MusicName,FileName))"));//我的收藏数据列表
